    ...
    try
    {
        ...
        return {
            users: [
                ...
                {id:4,name:"Paco",lastName:"Perez",photo:"https://www.csftw.edu/wp-content/uploads/Types-of-Chefs.jpg", email:"paco@gmail.com",phone:"1235487",profession:["Chef"],experience:[{}],education:[{}],skills:[],aboutMe:"",cv:"",rol:"user"},
...
export const getUserById = createAsyncThunk("getUserById", async (obj) =>
{
    try
    {
        ...
        return{
            users: {id:4,name:"Paco",last_name:"Perez",photo:"", email:"paco@gmail.com",phone:"1235487",profession:[],experience:[{}],education:[{}],skills:[],aboutMe:"",cv:"",rol:"user"}
        }
    }
    catch(error)
    {
